...
const ErrorImage = (
  <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    <defs>
      <linearGradient x1="50%" y1="-116.862%" x2="50%" y2="90.764%" id="error-block-image-default-a">
      ...
      <circle id="error-block-image-default-d" cx={18.823} cy={18.823} r={18.823} />
      <rect id="error-block-image-default-b" x={3.5} y={9} width={51.429} height={88} rx={4.571} />
    </defs>
    <g fill="none" fillRule="evenodd">
      ...
      <g transform="rotate(-90 102.429 55.357)">
        ...
        />
        <path stroke="#FFF" strokeWidth={0.75} strokeLinecap="round" strokeLinejoin="round" d="M36.774 5.474H21.523" />
        <path
      ...
      <circle cx={8.571} cy={8.571} r={8.571} transform="translate(22.857 142)" fill="#FFCD6B" fillRule="nonzero" />
      <g transform="translate(132.857 124)">
        <mask id="error-block-image-default-e" fill="#fff">
          <use xlinkHref="#error-block-image-default-d" />
        </mask>
        <use fill="#FBBE47" fillRule="nonzero" xlinkHref="#error-block-image-default-d" />
        <circle
          fill="#FFCD6B"
          fillRule="nonzero"
